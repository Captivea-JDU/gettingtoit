...
class MagentoProductProduct(models.Model):
    ...
    def exp_prd_stock_in_batches(self, stock_data, instance, api_url, data_key, method, job):
        ...
        start_to_rang = batch_size - 1
        total_stock_dict_pages = math.ceil(len(stock_data) / batch_size)
        end_range = start_range + start_to_rang if total_stock_dict_pages > 1 else len(
            stock_data) - 1
        for page in range(current_page, total_stock_dict_pages + 1):
            ...
            if stock_dict:
                ...
                end_range = start_range + start_to_rang
