...
class MagentoImportExportEpt(models.TransientModel):
    ...
    operations = fields.Selection([
        ...
        ('import_configurable_product', 'Import Configurable Products'),
        ('import_simple_product', 'Import Simple Products'),
    ...
    def on_change_operation(self):
        ...
        """
        if self.operations == "import_configurable_product" or self.operations == "import_simple_product" or self.operations == "import_sale_order" or self.operations == "import_cancel_orders":
    ...
    def execute(self):
        ...
        elif self.operations == 'import_configurable_product':
        ...
        elif self.operations == 'import_simple_product':
            from_date = datetime.strftime(self.start_date, MAGENTO_DATETIME_FORMAT) if self.start_date else None
            to_date = datetime.strftime(self.end_date, MAGENTO_DATETIME_FORMAT) if self.end_date else None
            product_queue = False
            p_types = 'simple'
